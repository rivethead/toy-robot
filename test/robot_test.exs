defmodule ToyRobot.RobotTest do
  ...
  describe "when the robot is facing north" do
    ...
    test "it moves 3 space north", %{robot: robot} do
      robot = robot |> Robot.move(3)

      assert robot.north == 3
    end

    test "it does uturn", %{robot: robot} do
    ...
    test "turn right to face east", %{robot: robot} do
  ...
  describe "when the robot is facing east" do
    setup  do
      {:ok, %{robot: %Robot{north: 0, facing: :east}}}
    end
    ...
    test "turn right to face south", %{robot: robot} do
      robot = robot |> Robot.turn_right
  ...
  describe "when the robot is facing south" do
    ...
    test "turn right to face west", %{robot: robot} do
      robot = robot |> Robot.turn_right
  ...
  describe "when the robot is facing west" do
    ...
    test "turn right to face north", %{robot: robot} do
      robot = robot |> Robot.turn_right
