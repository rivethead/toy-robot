defmodule ToyRobot.Simulation do
  ...
  @doc """
  Moves a robot forward in the direction that it is facing, unless that position is past the boundaries of the table. The number of spaces moved is based on the `number_of_spaces`. The variable has a default value of 1
  ...
  ### A valid movement where moving more than one space
  ...
  %Table{north_boundary: 4, east_boundary: 4}
  iex> simulation = %Simulation{table: table, robot: %Robot{north: 0, east: 0, facing: :north}}
  iex> simulation |> Simulation.move(3)
  {:ok, %Simulation{
  table: table,
  robot: %Robot{north: 3, east: 0, facing: :north}
  }}
  ...
  ### An invalid movement where moving more than one space
  ...
  %Table{north_boundary: 4, east_boundary: 4}
  iex> simulation = %Simulation{table: table, robot: %Robot{north: 0, east: 0, facing: :north}}
  iex> simulation |> Simulation.move(5)
  {:error, :at_table_boundary}

  """
  def move(%Simulation{robot: robot, table: table} = simulation, number_of_spaces \\ 1) do
    with moved_robot <- robot |> Robot.move(number_of_spaces),
